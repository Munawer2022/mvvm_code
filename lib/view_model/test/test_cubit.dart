...
//   removeToken({required BuildContext context}) => _localStorage
//       .removeUserInfo()
...
//   void onThemeChanged({required bool value}) => _updateTheme.updateTheme(value);
//   navigateToTestDetail(
//           {required BuildContext context, required TestModel model}) =>
